...
{
  $nav_titles = ['Home', 'Resume', 'Apply for Jobs', 'Job Offers'];
  $links = ['std_home.php', 'std_resume.php', 'std_job_apply.php', 'std_job_offers.php'];
