...
{
  $nav_titles = ['Home', 'Student Applications', 'Job Profiles', 'Accepted Offers'];
  $links = ['cmp_home.php', 'cmp_std_applications.php', 'cmp_profiles.php', 'cmp_accepted_offers.php'];
  ...
  echo '<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
        ...
        <symbol id="Student Applications" viewBox="0 0 16 16">
        ...
        <symbol id="Job Profiles" viewBox="0 0 16 16">
        ...
        <symbol id="Accepted Offers" viewBox="0 0 16 16">
